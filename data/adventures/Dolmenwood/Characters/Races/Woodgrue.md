...
Bat Ears
* By ambient noise, your own clicks, music, etc you can navigate in the dark.  You can only discern rough shape and fist-sized or larger features.
* You have advantage to listen.

Compulsive Jubilation
* On witnessing a feast, party, celebration, or festival, you feel a powerful urge to partake.
	* Refrain and become dejected (+A on stat rolls until a Long Rest).  Indulge and gain a Luck token (and are no longer dejected, if applicable).
* You can consume unlimited amounts of intoxicants, becoming extremely intoxicated, but never actually collapsing, blacking-out, etc and suffering no penalties to STR, CON, DEX, or CHA rolls.
...
* Effect
	...
	* Gluttony: targets ravenously consume available food and drink and act stumblingly drunk.
	* Jape: the preceded words, act, or event seems hilarious and mock-worthy.
	* Jubilate: targets can't speak, only laugh, whoop, bark, etc.  Slowed unless moving in the direction of the musician.  DEX DC 9 each round or fall down laughing.
