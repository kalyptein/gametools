...
* Bronze armor: 2x cost, -1 defense, non-iron
	* Skilled faerie smiths can make armor of bronze (or stranger materials) as good as iron.
* Mossling-craft: 5x cost, +1 defense, non-metallic
	* Bark ("leather") or Pinecone ("chainmail")
* Masterwork: 10x cost, +1 defense or -1 weight category
	* Armor only, not shields
...
* Flaming Oil
	* 1 gp, 1 slot, Throw Near, Finesse
	* Creates a burning Close area ("defense" 12 to strike the desired spot, a miss deviates its point of impact)).  Burns for 4 rounds, dealing d4 fire on exposure.
		* Multiple flasks of oil can be "stacked" in a single area, burning hotter.
* Caltrops
	* 1 gp, 1 slot, Throw Close
...
* Each time you make non-trivial use of the item, mark off a use.  If there aren't any more uses to mark off (you were at 0), the item is fully used up.
	* e.g. hammering in some pitons to secure rope or spiking a door would consume a use of iron spikes.  Pulling out 


Encumbrance

* Small: you can carry up to 3 Small items without any load.  Beyond this, Small items bundle into stacks of 3, 10, or 20.



* Free Slots (considered Readied)
