...
* Style
	...
	* Marksman: thrown and missile weapons
...
Combat Talents
* Cleave
	* If you fell a foe, you may immediately make another attack at -2.  This can chain further, with extra -2 per attack.  If you have the movement, you can move 5' between attacks.
* ???Last Stand
	* When you would drop to 0 hp, you drop to 1 hp.  Each time after this, Save vs Doom to stay at 1 hp, with -4 to each subsequent save.
	* If you would die, you can keep fighting for 5 rounds before dropping, but save vs Doom with each hit.
...
??? av rules, needs revamp for OSE numbers
- Favored weapon benefits (attacks per round stacks w/ warrior attack rate / missile RoF)
    - 1st: +1 attack, +1 damage
    - ??? 3rd: +0.5 attacks per round OR dual-wield with reduced penalty (-0 onhand / -4 offhand)
    - ??? 6th: +1 attack, +1 damage (stacks)
    - 9th: Increase damage die, reduce speed factor by 3
    - 12th: +0.5 attacks per round OR dual-wield with no penalty (-0 onhand / -0 offhand)
    - 15th: Crit on 18+

- To change favored weapon: 10 kills or 1 week training unlocks lowest level benefit for the new category, and locks the highest level favored weapon benefit from the previous category.

Means of Introduction
* Weary of war (perhaps the War of the Roses), perhaps dispossessed as a result, you seek seclusion from the bustle of the modern world.  Fate and rumor direct your feet to the back country of Dolmenwood.